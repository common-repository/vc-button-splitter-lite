...
class wps_vcs_bs_admin_enqueues {
  ...
  public function enqueue_script($file_desc, $file) {
    wp_enqueue_script($this->slug . '_' . $file_desc, WPS_VCS_BS_URI . 'admin/'. $file, array(), $this->version, true);
  } // enqueue_script


  public function enqueue_style($file_desc, $file) {
    wp_enqueue_style($this->slug . '_' . $file_desc, WPS_VCS_BS_URI . 'admin/'. $file, array(), $this->version);
  } // enqueue_style


} // wps_vcs_bs_admin_enqueues